...
//==============================================================================
package org.fao.geonet.services.snig;
...
import org.fao.geonet.services.main.SearchSuggestion.FrequencyComparator;
import org.fao.geonet.services.snig.SearchSuggestion.SORT_BY_OPTION;
import org.fao.geonet.services.main.SearchSuggestion.StartsWithComparator;
...
public class SearchSuggestion implements Service {
     ...
     */
    private String _defaultSearchField = "anysnig";
    ...
    public Element exec(Element params, ServiceContext context)
        ...
        //  Field to filter
        String filterField = Util.getParam(params, "filterField", "");
        String filterValue = Util.getParam(params, "filterValue", "");
        ...
        if (origin.equals("") || origin.equals(RECORDS_FIELD_VALUES)) {
            ...
            searcher.getSuggestionForFieldsWithFilter(context, fieldName, searchValue, filterField, filterValue, _config, maxNumberOfTerms, threshold, listOfSuggestions);
        }
